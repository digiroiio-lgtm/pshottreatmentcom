...
const contactFaqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How do I book a P-Shot consultation?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Simply message us on WhatsApp. A medical coordinator will reply within minutes, ask a few quick questions about your case, and arrange a doctor review — all within 5 minutes.",
      },
    },
    {
      "@type": "Question",
      name: "How much does P-Shot treatment cost?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our P-Shot treatment is £300 all-inclusive. This covers the doctor consultation, PRP extraction, the injection procedure, and aftercare. UK clinics charge £1,200–£2,000 for the same procedure.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Your initial WhatsApp consultation with our medical coordinator is completely free and has no obligation. A doctor will review your suitability at no cost.",
      },
    },
    {
      "@type": "Question",
      name: "Where are your clinics located?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "We operate in Istanbul and Antalya, Turkey. The full clinic address is shared after booking. We regularly treat patients from the UK, USA, Europe, and Australia.",
      },
    },
    {
      "@type": "Question",
      name: "How quickly will you reply on WhatsApp?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our medical coordinators are available 7 days a week, 8am–10pm (UTC+3). Average response time is under 2 minutes.",
      },
    },
  ],
};
...
const WhatsAppIcon = () => (
  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="WhatsApp" role="img">
