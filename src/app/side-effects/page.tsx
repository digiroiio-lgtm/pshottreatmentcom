...
export const metadata: Metadata = {
  ...
  description: "Learn about P-Shot side effects, safety, and recovery. P-Shot uses your own blood plasma – making it one of the safest regenerative procedures available.",
  keywords: ["P-Shot side effects", "is P-Shot safe", "P-Shot recovery", "P-Shot risks"],
  alternates: { canonical: "https://pshottreatment.com/side-effects" },
};
    ...
    <div className="pt-6">
      ...
      <div className="max-w-4xl mx-auto px-4 pb-10">
        <div className="bg-green-50 border border-green-200 rounded-2xl p-6 mb-8">
          ...
          <p className="text-green-700">The P-Shot (Priapus Shot) uses your own blood plasma (PRP – Platelet-Rich Plasma), which means there is virtually zero risk of allergic reaction or rejection. It has been performed on thousands of men worldwide.</p>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6">
          ...
          <p className="text-sm text-gray-500">The information on this page is for educational purposes only and does not constitute medical advice. Always consult a qualified medical professional before undergoing any procedure. Our doctors will perform a full assessment before your treatment.</p>
        </div>
      </div>
