        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <a href="https://wa.me/905XXXXXXXXX" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors">
              ...
              <p>Turkey | Serving UK, EU &amp; US patients</p>
            </div>
          </div>
        </div>
        <div className="border-t border-gray-800 pt-6 text-xs text-center">
          <p>© {new Date().getFullYear()} pshottreatment.com – Medical information is for educational purposes only. Always consult a qualified physician.</p>
          <p className="mt-1">
            Also check: <a href="https://pshotnearme.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">pshotnearme.com</a>
          </p>
        </div>
      </div>
    </footer>
